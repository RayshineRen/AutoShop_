...
<%@include file="/jsp/common/head.jsp"%>
	...
	<div class="right">
		...
		<div class="search">
			<form method="get" action="${pageContext.request.contextPath }/jsp/user/user.do">
				<input name="method" value="query" class="input-text" type="hidden">
				 ...
				 <a href="${pageContext.request.contextPath}/jsp/user/useradd.jsp" >添加用户</a>
				 <a href="${pageContext.request.contextPath}/importCSV" >导入CSV文件</a>
			</form>
		</div>
		<!--用户-->
